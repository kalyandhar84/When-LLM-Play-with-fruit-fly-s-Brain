...
# ---------------------------------------------------------------------------
neurons += [
    N("JO_A", "Johnston's organ A", "JO-A", "ammc", categories=["Auditory", "Sensory"], role="sensory",
      description="Auditory mechanosensory neuron from Johnston's organ."),
    N("JO_B", "Johnston's organ B", "JO-B", "ammc", categories=["Auditory", "Sensory"], role="sensory",
      description="Auditory sensory neuron conveying antennal vibration signals."),
...
payload = {
    ...
    "connections": edges,
    "journeys": journeys,
    "categories": ["Visual", "Olfactory", "Auditory", "Taste", "Motor", "Descending", "Sensory", "Central"],
}
